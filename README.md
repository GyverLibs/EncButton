...
- Для работы только с кнопкой, а также удобного наследования алгоритомв кнопки в другие классы и библиотеки рекомендую использовать библиотеку [VirtualButton](https://github.com/GyverLibs/VirtualButton). Она содержит те же алгоритмы опроса, что и здесь, но энкодер полностью убран и код ещё больше облегчён и оптимизирован. Методы полностью совместимы с EncButton
